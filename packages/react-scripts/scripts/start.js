...
const clearConsole = require('react-dev-utils-fresh/clearConsole');
...
const {
  ...
  prepareProxy,
  prepareUrls,
} = require('react-dev-utils-fresh/WebpackDevServerUtils');
const openBrowser = require('react-dev-utils-fresh/openBrowser');
